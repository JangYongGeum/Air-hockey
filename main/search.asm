...
;* Date/Time created: Tue Apr 04 14:43:46 2023                 *
;***************************************************************
...
;	C:\exhibition\Compiler\bin\opt2000.exe C:\Users\USER\AppData\Local\Temp\TI40810 C:\Users\USER\AppData\Local\Temp\TI4084 
;	C:\exhibition\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -IC:\exhibition\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\USER\AppData\Local\Temp\TI4082 --template_info_file C:\Users\USER\AppData\Local\Temp\TI4086 --object_file search.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist 
