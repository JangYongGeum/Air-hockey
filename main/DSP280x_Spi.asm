...
;	C:\exhibition\Compiler\bin\opt2000.exe C:\Users\USER\AppData\Local\Temp\TI92410 C:\Users\USER\AppData\Local\Temp\TI9244 
;	C:\exhibition\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -IC:\exhibition\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\USER\AppData\Local\Temp\TI9242 --template_info_file C:\Users\USER\AppData\Local\Temp\TI9246 --object_file DSP280x_Spi.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist 
	.sect	".text"
	.global	_SpiTx
...
DW$5	.dwtag  DW_TAG_subprogram, DW_AT_name("SpiTx"), DW_AT_symbol_name("_SpiTx")
	...
	.dwattr DW$5, DW_AT_begin_line(0x9a)
	.dwattr DW$5, DW_AT_begin_column(0x08)
	.dwpsn	"DSP280x_Spi.c",155,1
...
_SpiTx:
;*** 156	-----------------------    C$1 = &SpiaRegs;
;*** 156	-----------------------    (*C$1).SPITXBUF = Buf<<8;
;*** 157	-----------------------    *((volatile struct _SPISTS_BITS *)C$1+2L) |= 0x20u;
...
DW$8	.dwtag  DW_TAG_variable, DW_AT_name("Buf"), DW_AT_symbol_name("_Buf")
	...
	.dwpsn	"DSP280x_Spi.c",156,2
        MOV       ACC,AL << #8          ; |156| 
        MOVB      XAR0,#8               ; |156| 
        MOVL      XAR4,#_SpiaRegs       ; |156| 
        MOV       *+XAR4[AR0],AL        ; |156| 
	.dwpsn	"DSP280x_Spi.c",157,2
        OR        *+XAR4[2],#0x0020     ; |157| 
L1:    
DW$L$_SpiTx$2$B:
;***	-----------------------g2:
;*** 158	-----------------------    if ( !(*(&SpiaRegs+2L)&0x40u) ) goto g2;
	.dwpsn	"DSP280x_Spi.c",158,8
        MOVW      DP,#_SpiaRegs+2
        TBIT      @_SpiaRegs+2,#6       ; |158| 
        BF        L1,NTC                ; |158| 
        ; branchcc occurs ; |158| 
DW$L$_SpiTx$2$E:
;*** 160	-----------------------    return SpiaRegs.SPIRXBUF&0xffu;
	.dwpsn	"DSP280x_Spi.c",160,2
        AND       AL,@_SpiaRegs+7,#0x00ff ; |160| 
	.dwpsn	"DSP280x_Spi.c",161,1
        LRETR
        ; return occurs

DW$9	.dwtag  DW_TAG_loop
	.dwattr DW$9, DW_AT_name("C:\exhibition\main\DSP280x_Spi.asm:L1:1:1680587024")
	.dwattr DW$9, DW_AT_begin_file("DSP280x_Spi.c")
	.dwattr DW$9, DW_AT_begin_line(0x9e)
	.dwattr DW$9, DW_AT_end_line(0x9e)
DW$10	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$5, DW_AT_end_line(0xa1)
...
DW$14	.dwtag  DW_TAG_loop
	.dwattr DW$14, DW_AT_name("C:\exhibition\main\DSP280x_Spi.asm:L2:1:1680587024")
...
DW$28	.dwtag  DW_TAG_loop
	.dwattr DW$28, DW_AT_name("C:\exhibition\main\DSP280x_Spi.asm:L3:1:1680587024")
...
DW$29	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$16, DW_AT_end_line(0x97)
...
DW$42	.dwtag  DW_TAG_loop
	.dwattr DW$42, DW_AT_name("C:\exhibition\main\DSP280x_Spi.asm:L5:1:1680587024")
